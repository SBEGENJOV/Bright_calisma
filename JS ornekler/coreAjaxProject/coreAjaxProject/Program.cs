...
builder.Services.AddDbContext<ApplicationDbContext>(option => option.UseSqlServer("Server=DESKTOP-5K7HMBT\\SQLEXPRESS;Database=ajxcore;Integrated Security=true;"));
